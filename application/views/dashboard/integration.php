      ...
      <section>
            ...
            <div class="panels marginbtm-10">
              <div class="main-heading">
                  <span class="fontcolor-primary text-bold fontsize18"> Integration </span>
            ...
            <div class="row ">
                <form action="<?= site_url('Dashboard/integration') ?>" method="post" style="width: 100%;">

                  <!-- social Board Area -->

                  <div class="col-lg-12" style="padding:0;">
                  
                    <div class="pd50tb text-center" id="wd">                    
                          <div class="col-md-12" style="padding:0;">

                             <div class="col-lg-4">
                                <div class="item">
                                    <label class="switch">
                                      <input type="checkbox" class="checkbox_facebook" name="facebook" id="facebook" value="1" <?php if(!empty($facebook_data)){ echo "checked"; } ?>>
                                      <span class="slider round"></span>
                                    </label>
                                    <img src="<?= site_url('cms-assets/img/Face.png') ?>" /><br>
                                    <small class="sm" >Facebook</small>
                                    
                                    <div class="" style="padding: 10px 12px; margin-bottom: 9px;"> 
                                    </div>
                                </div>
                              </div>
                              ...
                              <div class="col-lg-4">
                                <div class="item">
                                   <label class="switch">
                                    ...
                                    <img src="<?= site_url('cms-assets/img/Twit.png') ?>" /><br>
                                    <small class="sm">Twitter</small>
                                    <div class="" style="padding: 10px 12px; margin-bottom: 9px;">
                            ...
                            <!-- 3 -->
                              <div class="col-lg-4">
                                <div class="item"> 
                                    ...
                                    <img src="<?= site_url('cms-assets/img/Link.png') ?>" /><br>
                                    <small class="sm">LinkedIn</small>
                                    <div class="" style="padding: 10px 12px; margin-bottom: 9px;">
                            ...
                            <!-- 4 -->
                              <!-- <div class="col-lg-3">
                                <div class="item"> 
                                    <label class="switch">
                                     <input type="checkbox" name="instagram" id="instagram" value="1" <?php if(!empty($instagram_data)){ echo "checked"; } ?>>
                                     <span class="slider round"></span>
                                     </label>
                                    <img src="<?= site_url('cms-assets/img/insta.png') ?>" /><br>
                                    <small class="sm">Instagram</small>
                                    <div class="" style="padding: 10px 12px; margin-bottom: 9px;">
                      ...
                      <div class="col-lg-6" id="facebook_company_page" <?php if (empty($facebook_data['facebook_company_list'])) { ?> style="display: none;" <?php }else{ ?> style="display: block;" <?php } ?> >
                        <div class="item text-center">
                           <img src="<?= site_url('cms-assets/img/Face.png') ?>" style="height: 88px;width: 150px;margin-top: -16px;"/><br>
                           <h4 class="fontcolor-primary text-bold" style="margin-top:0px;">Facebook</h4>
                              <div class="col-lg-12" style="padding: 10px 12px; margin-bottom: 9px;">
                      ...
                      <div class="col-lg-6" id="linkedin_company" <?php if (empty($linkedin_data['linkedin_company_list'])) { ?> style="display: none;" <?php }else{ ?> style="display: block;" <?php } ?>>
                        <div class="item text-center">
                            <img src="<?= site_url('cms-assets/img/Link.png') ?>" style="height: 86px;width:150px;margin-top: -16px;" /><br>
                           <h4 class="fontcolor-primary text-bold" style="margin-top: 6px;">LinkedIn</h4>
                              <div class="col-lg-12" style="padding: 10px 12px; margin-bottom: 9px;">
...
$('#facebook').click(function() {
    ...
    window.location = "<?= site_url('FacebookAuth/facebook_sign_in') ?>";
    }else {
        swal({
         title: "Are you sure?",
       ...
       .then((willDelete) => {
         if (willDelete) {
           $.ajax({
           type: "POST",
                url: "<?= site_url('FacebookAuth/facebook_remove_credentials') ?>",
                async : false,
...
$('#switch').click(function() {
  ...
  window.location = "<?= site_url('TwitterAuth/twitter_sign_in') ?>";
   }else {
       swal({
       title: "Are you sure?",
     ...
     .then((willDelete) => {
       if (willDelete) {
         $.ajax({
         type: "POST",
              url: "<?= site_url('TwitterAuth/twitter_remove_credentials') ?>",
              async : false,
...
$('#linkedin').click(function() {
   ...
   window.location = "<?= site_url('LinkedInAuth/linkedin_sign_in') ?>";
   }else {
       swal({
        title: "Are you sure?",
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
          type: "POST",
               url: "<?= site_url('LinkedInAuth/linkedin_remove_credentials') ?>",
               async : false,
